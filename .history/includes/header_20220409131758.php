...
<header>
  <div class="default-header">
        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            ...
            <div class="header_widgets">
              ...
              <a href="tel:61-1234-5678-09">+221 776113017</a> </div>
   ...
   <?php   if(strlen($_SESSION['login'])==0)
	{	
?>
 <div class="login_btn"> <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Se Connecter / Register</a> </div>
<?php }
else{ 

echo "Bienvenue sur le portail de location d'appartements";
 } ?>
          </div>
        </div>
      </div>
...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
          ...
          <li><a href="my-testimonials.php">MON TÉMOIGNAGE</a></li>
            ...
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">MA RÉSERVATION</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="car-listing.php">APPARTMENTS</a>
