...
<head>
	...
	<title> Admin modifier Image 5</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Image de Vehicule 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Detail l'image de Vehicule 5</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Image5 actuelle</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Modifier la Nouvelle Image 5<span style="color:red">*</span></label>
												<div class="col-sm-8">
