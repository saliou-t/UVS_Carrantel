...
<head>
	...
	<title>Admin Modifier les Info de Vehicule</title>
...
<div class="form-group">
<label class="col-sm-2 control-label">Prix ​​par jour (en USD)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Capacité d'accueil<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Modifier Image 1</a>
</div>
<div class="col-sm-4">
Image 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Modifier Image 2</a>
</div>
<div class="col-sm-4">
Image 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>">Modifier Image 3</a>
</div>
</div>
...
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">Modifier Image 4</a>
</div>
<div class="col-sm-4">
Image 5
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">Modifier Image 5</a>
<?php } ?>
</div>
...
<label for="inlineCheckbox2">Verrouillage centralisé</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">Modifier</button>
												</div>
											</div>
