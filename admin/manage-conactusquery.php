...
$msg="Témoignage réussi Inacrive";
}
...
<head>
	...
	<title>Admin Gérer les demandes des utilisateur   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gérer les demandes des utilisateurs</h2>
...
<td><a href="manage-conactusquery.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez-vous vraiment lire')" >En attendant</a>
</td>
<?php } ?>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
