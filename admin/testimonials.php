...
$msg="Témoignage avec succès Inacrive";
}
...
<head>
	...
	<title>Admin Gérer les témoignages   </title>
...
{
	?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez-vous vraiment Activer')"> Inactive</a>
<?php } else {?>

<a href="testimonials.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez-vous vraiment inactif')"> Active</a>
</td>
<?php } ?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
