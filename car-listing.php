...
<title>Appartements disponibles</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Annonce de voiture</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Accueil</a></li>
        <li>Annonce de voiture</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn">Voir les Detaills <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
