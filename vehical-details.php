...
if($lastInsertId)
{
echo "<script>alert('réservation avec cuccés.');</script>";
}
else 
{
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Aperçu du véhicule </a></li>
...
<tr>
<td>Systeme de freinage antiblocage</td>
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input type="text" class="form-control" name="fromdate" placeholder="Du Date(jj/mm/aaaa)" required>
            </div>
            <div class="form-group">
              <input type="text" class="form-control" name="todate" placeholder="À ce jour(jj/mm/aaaa)" required>
            </div>
            <div class="form-group">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Envoyer</a>
